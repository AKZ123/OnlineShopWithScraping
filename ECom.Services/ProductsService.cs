...
namespace ECom.Services
{
    public class ProductsService
    {
        ...
        public List<Product> GetProducts()
        {
            using (var context = new CBContext())
            {
                return context.Products.Include(x => x.Category).ToList();  //Product ar satay Category add korar jonno System.Data.Entity.Include()  use kora hoy.

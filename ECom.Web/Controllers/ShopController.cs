...
namespace ECom.Web.Controllers
{
    public class ShopController : Controller
    {
        ...
        //    if (!string.IsNullOrEmpty(productIDs))
        //    {
        //        var OrderedAllProductId = productIDs.Split('-').Select(x => int.Parse(x)).ToList();
        //        var broughtProducts = ProductsService.Instance.GetProducts(OrderedAllProductId.Distinct().ToList());
        //        Order newOrder = new Order();
        //        newOrder.UserID = User.Identity.GetUserId();
        //        newOrder.OrderedAt = DateTime.Now;
        //        newOrder.Status = "Pending";
        //        newOrder.TotalAmount = broughtProducts.Sum(x => x.Price * OrderedAllProductId.Where(y => y == x.ID).Count());
        //        newOrder.OrderItems = new List<OrderItem>();
        //        newOrder.OrderItems.AddRange(broughtProducts.Select(x => new OrderItem() { ProductID = x.ID, Quantity = OrderedAllProductId.Where(y => y == x.ID).Count() }));
